...
export default async function TestPage() {
  ...
  return (
    <main className="flex min-h-dvh items-center justify-center bg-(--bg-gradient) px-6 text-foreground">
      <div className="w-full max-w-2xl border-2 border-(--border) bg-background px-8 py-10 shadow-[8px_8px_0_rgba(var(--shadow-ink),0.16)]">
